...
<div class="card mt-1 mb-1 border-dark">
  ...
  <div class="card-body">
    ...
    {#if order.quote_enabled}
      <p><strong>Текст цитаты:</strong> <span>{order.quote_text}</span></p>
      <p>
        <strong>Автор цитаты:</strong> <span>{order.quote_author_text}</span>
      </p>
    {/if}

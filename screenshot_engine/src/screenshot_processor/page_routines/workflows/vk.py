...
def vk_post_routine(driver: webdriver.Remote) -> WebElement:
    driver.execute_script("window.scrollTo(0,0)")
    post = driver.find_element(By.CLASS_NAME, "wall_module")
    return post


def vk_profile_routine(driver: webdriver.Remote) -> WebElement:
    driver.execute_script("document.body.style.zoom = '1.2'")
    return driver.find_element(By.TAG_NAME, "body")


def extract_vk_profile_url(driver: webdriver.Remote) -> str:

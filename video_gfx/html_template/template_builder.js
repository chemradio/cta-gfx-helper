...
function buildHTML(config) {
	...
	let backgroundAnimator = document.createElement('div');
	backgroundAnimator.setAttribute(
		'class',
		config.backgroundClass + ' background-fitter'
	);
	// backgroundAnimator.setAttribute('class', config.backgroundClass);
	...
	backgroundContainer.append(backgroundAnimator);
	backgroundAnimator.append(backgroundImage);

...
class ErrorResponses:
    ...
    text_too_short: str = "🆘 Текст слишком короткий."
...
class VideoFilesResponses:
    send_main_file: str = "🎨 Пришли основной файл для графики (JPEG / PNG / PDF)."
    select_background_source: str = """🎨 Подложка: у тебя есть файл или сделать скриншот с сайта?
...
Графика без подложки делается только из высококачественного скриншота с веб-сайта. Не выбирай БЕЗ ПОДЛОЖКИ, если не уверен в этом абсолютно."""
    send_background_file: str = "🎨 Пришли мне файл для подложки (JPEG / PNG / PDF)."
    send_background_link: str = "🔗 Пришли мне ссылку для подложки."

    # the following to be deprecated
